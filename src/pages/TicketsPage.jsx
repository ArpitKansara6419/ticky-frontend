                ...
                <div style={{ marginTop: '32px', padding: '24px', background: '#f8fafc', borderRadius: '16px', border: '1px solid #e2e8f0', borderLeft: '4px solid #6366f1' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
                    <div style={{ background: 'white', padding: '12px', borderRadius: '12px', border: '1px solid #f1f5f9' }}>
                      ...
                      <div style={{ fontSize: '16px', fontWeight: '900', color: '#1e293b' }}>{selectedTicket.currency} {parseFloat(liveBreakdown?.grandTotal ?? selectedTicket.totalCost ?? 0).toFixed(2)}</div>
                    </div>
                    <div style={{ background: 'white', padding: '12px', borderRadius: '12px', border: '1px solid #f1f5f9' }}>
                      ...
                      <div style={{ fontSize: '16px', fontWeight: '900', color: '#64748b' }}>{selectedTicket.engCurrency || selectedTicket.currency} {parseFloat(payoutLiveBreakdown?.grandTotal ?? selectedTicket.engTotalCost ?? 0).toFixed(2)}</div>
                    </div>
                    <div style={{ background: 'linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%)', padding: '12px', borderRadius: '12px', border: '1px solid #10b981' }}>
                      ...
                      <div style={{ fontSize: '16px', fontWeight: '900', color: '#059669' }}>
                        {selectedTicket.currency} {(
                          parseFloat(liveBreakdown?.grandTotal ?? selectedTicket.totalCost ?? 0) - 
                          parseFloat(payoutLiveBreakdown?.grandTotal ?? selectedTicket.engTotalCost ?? 0)
                        ).toFixed(2)}
                      </div>
                    </div>
                  </div>
